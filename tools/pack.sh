...
# ── per-component knobs ──────────────────────────────────────────────────────
ID=lumen-netman                  # herald package id (== repo name)
NAME="Network manager"           # human-readable name
DESTBIN=apps/netman/netman       # where the binary installs (verbatim runtime path)
